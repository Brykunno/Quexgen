...
const handleSubmitExam = () =>{
  ...
  return (
    <DataContext.Provider value={{setTotalItems,totalItems,handleTotalItemsChange,handleInnerLessonDataChange,handleOneAllocation,handleLessonDataChange,lessonsDataInitial,setLessonsDatainitial,Remembering,Understanding,Applying,Analyzing,Evaluating,Creating,setRemembering,setUnderstanding,setApplying,setAnalyzing,setEvaluating,setCreating,setFormData,formData}} >
    <Admin_layout title={"Create Exam"}>
